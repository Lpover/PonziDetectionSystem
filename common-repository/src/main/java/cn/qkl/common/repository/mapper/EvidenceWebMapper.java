...
public interface EvidenceWebMapper {
    ...
    @Results(id="EvidenceWebResult", value = {
        ...
        @Result(column="evidence_phase", property="evidencePhase", jdbcType=JdbcType.BIGINT),
        @Result(column="evidence_type", property="evidenceType", jdbcType=JdbcType.BIGINT),
