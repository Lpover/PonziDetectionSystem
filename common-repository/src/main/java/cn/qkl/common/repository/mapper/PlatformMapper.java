...
public interface PlatformMapper {
    ...
    @Results(id="PlatformResult", value = {
        ...
        @Result(column="monitor", property="monitor", jdbcType=JdbcType.BIT),
        @Result(column="risk_content_num", property="riskContentNum", jdbcType=JdbcType.BIGINT),
        @Result(column="activation", property="activation", jdbcType=JdbcType.BIT),
        @Result(column="risk_level", property="riskLevel", jdbcType=JdbcType.BIT),
        @Result(column="update_time", property="updateTime", jdbcType=JdbcType.BIGINT),
        @Result(column="platform_type", property="platformType", jdbcType=JdbcType.BIT),
        @Result(column="logo", property="logo", jdbcType=JdbcType.VARCHAR),
        @Result(column="location", property="location", jdbcType=JdbcType.BIT),
        @Result(column="frequency", property="frequency", jdbcType=JdbcType.BIT),
        @Result(column="crawler_file", property="crawlerFile", jdbcType=JdbcType.VARCHAR),
        @Result(column="web3_type", property="web3Type", jdbcType=JdbcType.TINYINT),
