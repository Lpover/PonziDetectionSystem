...
public interface ContentMapper {
    ...
    @Results(id="ContentResult", value = {
        ...
        @Result(column="dynamic_recognition", property="dynamicRecognition", jdbcType=JdbcType.BIT),
        @Result(column="revised", property="revised", jdbcType=JdbcType.BIT),
        @Result(column="risk_level", property="riskLevel", jdbcType=JdbcType.BIT),
        @Result(column="content_type", property="contentType", jdbcType=JdbcType.BIT),
